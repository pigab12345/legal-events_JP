...
対象とするイベントの範囲（幅広く拾ってください）:
- 学会・専門シンポジウム・判例研究会（研究者・実務家向け）
- 大学等が開く一般向け公開講義・公開講座（学生・社会人向けの分かりやすい法学入門講座も含む）
- 市民向け法律講座・法教育イベント（消費者被害、労働問題など生活に身近なテーマも含む）
- 司法試験・予備試験の受験者向けガイダンス・説明会
- 司法修習生向けの説明会・研修イベント
- 法曹（弁護士・検察官・裁判官等）を目指す学生向けの就職・進路説明会、法律事務所や官公庁の業務説明会・インターンシップ説明会
...
- access: 一般参加可否。"可" "不可" "要問合せ" のいずれか。会員限定・学内限定なら"不可"、
  学生・一般市民・受験生等も参加可能なら"可"としてください。
...
（例: "大学 法学部 シンポジウム 一覧", "弁護士会 公開講座", "学会 大会案内 法学", "判例研究会 告知",
  ...
  "司法修習生 説明会", "法律事務所 就活 説明会 学生", "検察庁 裁判所 業務説明会 学生" など）

探す対象（専門家向けだけでなく、学生・一般・受験生向けも幅広く含めてください）:
...
- 司法修習生向け説明会・研修情報サイト
- 法律事務所・検察庁・裁判所・企業法務部等の就活・進路説明会、業務説明会、インターンシップ情報サイト
